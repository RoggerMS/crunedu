...
| `docs/UNIVERSITY_MODULE_PLAN.md` | Universidad MVP+: schema extendido, backend completo (overview, calendar, search, saves, reminders, ICS, admin), frontend hub con calendario real conectado a BD, filtros URL, paneles de datos reales | In progress | Alta: 2026-06-20. Fases 1-4 completadas (schema+seed, backend endpoints, frontend hub, calendario completo). Fase 5 parcial. Fase 6 pendiente. Actualizado 2026-06-20: calendario con vistas mes/semana/agenda, agenda diaria real, detalle modal, guardados/recordatorios/ICS funcionales. |
