...
| `docs/UNIVERSITY_MODULE_PLAN.md` | Universidad MVP+: schema extendido, backend completo (overview, calendar, search, saves, reminders, ICS, admin), frontend hub con calendario real conectado a BD, filtros URL, paneles de datos reales | In progress | Alta: 2026-06-20. Fases 1-3 completadas (schema+seed, backend endpoints, frontend hub). Pendientes: vistas calendario completo, agenda diaria, admin frontend, adjuntos, notificaciones. |
