...
export function FeedAttachmentPreview({ files, images, onRemoveFile, onRemoveImage }: { files: LocalAttachmentFile[]; images: Array<{ id: string; previewUrl?: string; alt?: string }>; onRemoveFile?: (id: string) => void; onRemoveImage?: (id: string) => void }) {
