  ...
  return (
    <article className="grid gap-3 rounded-3xl border border-slate-200 bg-white p-4 shadow-soft sm:grid-cols-2 lg:grid-cols-5">
      ...
      <SelectField
        ...
        value={voiceFilter}
        onChange={onVoiceFilterChange}
        options={[
          { value: "all", label: "Todos" },
          { value: "voice", label: "Disponible con voz" },
          { value: "text", label: "Solo texto / no voz" },
        ]}
      />
      <SelectField
        label="Universidad"
        ...
        options={[
          ...
          { value: "cantuta", label: "La Cantuta" },
          { value: "other", label: "Otra / no especificada" },
        ]}
      />
      <SelectField
        label="Tipo de ayuda"
        value={helpTypeFilter}
        onChange={onHelpTypeFilterChange}
