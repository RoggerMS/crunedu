...
export const fallbackMoments: MomentItem[] = [
  ...
  createdAt: h(i + 1), expiresAt: exp(24 - i), tags: m[5] as string[], media: [],
...
export const fallbackNews: MomentNewsSummary[] = [
  { id: "n1", title: "Cola en Tesorería durante la mañana", summary: "Muchos estudiantes reportan filas largas y atención lenta.", tags: ["Tesorería", "Campus", "Aviso"], status: "active", relatedMomentIds: ["m2"], updatedAt: h(1), stats: { boosts: 142, confirmations: 28, comments: 17, photos: 6 } },
  { id: "n2", title: "Cine universitario llenó el auditorio", summary: "Gran asistencia al ciclo de cine esta tarde.", tags: ["Cultura", "Evento", "Campus"], status: "active", relatedMomentIds: ["m5"], updatedAt: h(2), stats: { boosts: 298, confirmations: 65, comments: 31, photos: 12 } },
  { id: "n3", title: "Problemas con el sistema de matrícula", summary: "Varios estudiantes reportan errores y lentitud al ingresar.", tags: ["Matrícula", "Aviso", "Sistema"], status: "in_progress", relatedMomentIds: ["m3"], updatedAt: h(3), stats: { boosts: 188, confirmations: 42, comments: 25, photos: 3 } },
];
