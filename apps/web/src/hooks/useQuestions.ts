...
type ApiQuestion = {
  ...
  answers: Array<{ id: number; content: string; createdAt: string; isUseful?: boolean; votesScore?: number; upvotes?: number; downvotes?: number; images?: Array<{ id: number; imageUrl: string; mimeType: string; sizeBytes: number; position: number }>; author: { firstName: string | null; lastName: string | null; email: string } }>;
};
