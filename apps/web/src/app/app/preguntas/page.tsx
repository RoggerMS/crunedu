...
export default function QuestionsPage() {
  const { questions, stats, toast, notify, vote, save, loading, error, retry, shouldUseMock } = useQuestions();
