...
export default function QuestionsPage() {
  const { questions, stats, toast, notify, addQuestion, vote, save, addAnswer, expanded, setExpanded, saveDraft } = useQuestions();
