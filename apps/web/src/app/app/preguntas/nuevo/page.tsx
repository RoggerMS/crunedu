      ...
      <div className="space-y-4">
        ...
        <form onSubmit={onSubmit} className="space-y-4 rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="flex flex-wrap gap-2">
            <button type="submit" disabled={!canSubmit || !isAuthenticated} className="rounded-xl bg-brand-600 px-5 py-2 font-semibold text-white disabled:bg-slate-300">{submitting ? "Publicando..." : "Publicar pregunta"}</button>
