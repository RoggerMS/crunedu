...
export default function MomentsPage() {
  ...
  return <MomentsPortalLayout><MomentsHeader activeView={moments.activeView} setActiveView={moments.setActiveView} query={moments.query} setQuery={moments.setQuery} />
    ...
    <button onClick={() => setShowCreate(true)} title="Crear momento" aria-label="Crear momento" className="group fixed bottom-6 right-6 rounded-full bg-indigo-600 p-4 text-white shadow-[0_16px_32px_-10px_rgba(79,70,229,0.55)] transition hover:scale-105 hover:brightness-110">+</button>
