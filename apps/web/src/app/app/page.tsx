...
export default function AppPage() {
  ...
  return <div className="space-y-5">
    ...
    <div className="mt-6 space-y-4">{loading ? <StatusMessage type="loading">Cargando publicaciones...</StatusMessage> : null}{error ? <StatusMessage type="error">{error}</StatusMessage> : null}
